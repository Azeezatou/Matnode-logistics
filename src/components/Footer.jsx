        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-start">
            ...
            <div className="font-Rubik w-full md:w-1/5 mb-8 md:mb-0">
                ...
                {FooterLinks.map((footer) => (
                    <ul>
                        <li className="py-1">{footer.title}
                        </li>
                    </ul>
                ))}
            </div>
            ...
            <div className="w-full md:w-1/3">
                ...
                <p><span className="text-blue-600">Address:</span> 8, Eniyansoro Beyioku Street, off Ajao St, Surulere, Lagos</p>
                <p className=" my-2"><span className="text-blue-600">Email:</span> office@matnode.com</p>
                <p><span className="text-blue-600">Phone number:</span> +234 01-291 6911</p>
            </div>
        </div>

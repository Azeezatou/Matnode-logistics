    ...
    <div className="bg-[#f9f9f9] p-8">
        ...
        <div className=" p-5">
            <div className="text-center ">
                <h3 className="font-bold font-Oswald text-3xl  stroke-text2 tracking-wide">OUR SERVICES</h3>
                <h1 className="font-bold font-Oswald text-3xl md:text-4xl my-3">Trusted for our Services</h1>
                <p className="font-Rubik mb-4 items-center">Lorem Ipsum is simply dummy text of the printing and typesetting industry <br/> the standard dummy text ever since the when a printer took.</p>
            </div>
        </div>
                ...
                <div className="transform transition-transform duration-300 hover:scale-90 ">
                    ...
                    <div className=""> </div>
                        ...
                        <div className="flex mb-4 ">
                            <div className="text-[#ff8a00] font-Oswald font-extrabold text-5xl mr-3">0{service.id}</div>
                            <h2 className=" text-xl font-semibold font-Oswald text-black mb-2 ">{service.title}</h2>
                        </div>
                        <p className="text-gray-700 font-normal font-Rubik text-sm">{service.description}</p>
                    </div>
                </div>
            ) )}
        </div>

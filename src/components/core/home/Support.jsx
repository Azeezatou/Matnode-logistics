    ...
    <div className='container mb-12'>
      ...
      <div className='container bg-primary flex mb-2 md:mb-4'>
        ...
        <div className='text-left m-auto'>
          ...
          <Link to='/quote'>
            <button className='bg-[#1b1603] my-4 text-white p-9 text-sm md:text-xl lg:px-5 py-3 font-Rubik font-semibold text-center uppercase hover:text-black hover:bg-primary hover:border-2 hover:border-black' id='quote'>
            Get Quote
            </button>
          </Link>
        </div>

      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 container'>
        {services.map((service) => (
          <div className='transform transition-transform duration-300 hover:scale-90 '>
            <div className='p-6 m-5 bg-white  shadow-md hover:shadow-lg transition-shadow border relative'>
              <div className=" bg-secondary absolute top-0 left-0 h-14 w-2"></div>
              <div className='flex'>

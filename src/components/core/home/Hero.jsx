    ...
    <div className=" flex flex-col sm:flex-row h-auto md:bg-[url('../assets/images/port.jpg')] ">
      ...
      <div className=' text-white bg-[#1b1603] md:p-24 p-16 flex flex-col items-center justify-center md:w-1/2 min-h-[620px] '>
        <div className='relative container '>
          ...
          <Link to='/quote'>
            <button className='bg-primary text-[#1b1603] text-sm px-7 py-3 font-Rubik font-medium text-center tracking-wider  hover:bg-[#1b1603] hover:text-primary hover:border-2 hover:border-primary' id='quote'>
            GET QUOTE
            </button>
          </Link>
